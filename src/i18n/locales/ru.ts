...
Нажмите кнопку ниже, чтобы продолжить.`,
  ...
  story: {
    prompt:
      ...
      'После подтверждения администратора вы получите *+15 очков*!\n\n' +
      '📎 Отправьте фото (с подписью по желанию).',
    promptRepeat:
      '📸 *Отправить историю (Скриншот)*\n\n' +
      'Отправьте скриншот вашей истории.\n' +
      'После подтверждения администратором вы получите *+5 очков*!\n\n' +
      '📎 Отправьте скриншот (подпись необязательна).',
    alreadyBonused: '✅ Вы уже получили бонус за историю.',
    pending: '⏳ Ваша история проверяется. Пожалуйста, подождите.',
    submitted:
      '✅ *История отправлена!*\n\n' +
      'После проверки администратором вам будет начислено *+15 очков*.',
    submittedRepeat:
      '✅ *История отправлена!*\n\n' +
      'После проверки администратором вам будет начислено *+5 очков*.',
    cooldown: (hours: number) =>
      `⏳ Следующую историю можно отправить через ${hours} ч.`,
  },
